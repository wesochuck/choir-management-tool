      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
        <thead>
          <tr style={{ borderBottom: '1px solid var(--border)' }}>
            ...
            <th className="text-label" style={{ padding: 'var(--space-md)', color: 'var(--text-muted)', textAlign: 'center' }}>RSVP Status</th>
            <th className="text-label" style={{ padding: 'var(--space-md)', color: 'var(--text-muted)', textAlign: 'right' }}>Actions</th>
          </tr>
        </thead>
        <tbody>
          {singers.map((s) => {
