...
export const EventList: React.FC<EventListProps> = ({ events, auditionSettings, onEdit, onEmailReminder, onTextReminder, onViewRoster }) => {
  return (
        ...
        >
          <div className="flex-col" style={{ gap: 'var(--space-xs)' }}>
            <div className="flex-row" style={{ gap: 'var(--space-md)' }}>
              ...
              {auditionSettings?.enabled && auditionSettings.defaultPerformanceId === e.id && (
                <span className="badge badge-success">Auditions Open</span>
              )}
