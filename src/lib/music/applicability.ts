 ...
 */
export function pieceAppliesToSectionBucket(
 ...
 */
export function getSectionBucketApplicabilityLabel(
  piece: Partial<MusicPiece>,
  sections: SectionDef[]
): string {
  if (!piece.sectionBuckets || piece.sectionBuckets.length === 0) {
 ...
 */
export function filterPiecesBySectionBucket(
  pieces: MusicPiece[],
