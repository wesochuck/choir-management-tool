    ...
    >
      <div style={{ 
        ...
        {[
          ...
          { to: '/admin/rsvp', icon: '📬', label: 'Event RSVPs', desc: 'Track responses and roster balances' },
          { to: '/admin/polls', icon: '📊', label: 'Engagement Polls', desc: 'Review volunteer responses and counts' },
