...
import { formatSecondsToDuration, parseDurationToSeconds } from '../../../../lib/musicPieceUtils';
...
import { getMovementTrackCount, isParentPiece } from './musicLibraryTableUtils';
    ...
    >
      ...
      <td className="border-border border px-[10px] py-[6px] text-center align-middle font-semibold">
        {piece.performances && piece.performances.length > 0 ? (
          <span>{piece.performances.length}</span>
        ) : (
          '-'
        )}
      </td>
