...
export function MovementBadge() {
  return (
    <span className="text-muted inline-flex items-center rounded-[4px] border border-[rgb(100_116_139_/_20%)] bg-[rgb(100_116_139_/_10%)] px-[5px] py-[1px] text-[9px] leading-[1.2] font-medium">
      Movement
    </span>
  );
}
