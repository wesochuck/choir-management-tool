...
[x] the edit piece music player should have a longer track scrubber also on the floating one.
[ ] music library section filter should be multi select. refactor the UI to fit more.
[x] handle and warn on dirty saves in the choir settings.
...
[x] make it easier to include a roster singer who hasn't rsvpd' quickly ot th seating chart, rename "Add Singer" to "Add New Singer" and add "Looku Singer"
