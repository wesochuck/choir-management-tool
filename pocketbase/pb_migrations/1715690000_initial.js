...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "system": false,
      "type": "auth",
      "updateRule": "@request.auth.role = \"admin\" || ( id = @request.auth.id && @request.body.role:isset = false && @request.body.verified:isset = false )",
      "verificationTemplate": {
        "body": "<p>Hello,</p>\n<p>Thank you for joining us at {APP_NAME}.</p>\n<p>Click on the button below to verify your email address.</p>\n<p>\n  <a class=\"btn\" href=\"{APP_URL}/_/#/auth/confirm-verification/{TOKEN}\" target=\"_blank\" rel=\"noopener\">Verify</a>\n</p>\n<p>\n  Thanks,<br/>\n  {APP_NAME} team\n</p>",
        "subject": "Verify your {APP_NAME} email"
      },
    ...
    },
    {
      ...
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.role = \"admin\" || ( user = @request.auth.id && @request.body.globalStatus:isset = false && @request.body.voicePart:isset = false && @request.body.notes:isset = false )",
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "hidden": false,
          "id": "relation2818714156",
          "maxSelect": 1,
          "minSelect": 0,
          "name": "parentPerformanceId",
          "presentable": false,
          "required": false,
          "system": false,
          "type": "relation"
    ...
    {
      "createRule": "@request.auth.role = \"admin\" || (profile.user = @request.auth.id && @request.body.attendance:isset = false && @request.body.folderNumber:isset = false && @request.body.folderReturned:isset = false)",
      "deleteRule": "@request.auth.role = \"admin\"",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
      ...
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.role = \"admin\" || (profile.user = @request.auth.id && @request.body.attendance:isset = false && @request.body.folderNumber:isset = false && @request.body.folderReturned:isset = false)",
    ...
    },
    {
      ...
      "id": "pbc_settings_001",
      "indexes": [],
      "listRule": "@request.auth.role = \"admin\" || @request.auth.collectionName = \"_superusers\" || isPublic = true",
      "name": "appSettings",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.role = \"admin\" || @request.auth.collectionName = \"_superusers\"",
      "viewRule": "@request.auth.role = \"admin\" || @request.auth.collectionName = \"_superusers\" || isPublic = true"
    },
    {
      "createRule": "@request.auth.role = \"admin\" || @request.auth.collectionName = \"_superusers\"",
      "deleteRule": "@request.auth.role = \"admin\" || @request.auth.collectionName = \"_superusers\"",
  ...
  app.importCollections(snapshot, true);
