migrate((app) => {
  ...
  addAutodates(app.findCollectionByNameOrId("pbc_venues_001"));
  app.save(app.findCollectionByNameOrId("pbc_venues_001"));

  addAutodates(app.findCollectionByNameOrId("pbc_settings_001"));
  app.save(app.findCollectionByNameOrId("pbc_settings_001"));
}, (app) => {
