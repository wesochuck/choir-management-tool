...
import { decodeGoBytes, parseJsonField } from '../../pocketbase/pb_hooks_src/email/hookJson';
...
test('decodeGoBytes - Go byte array', () => {
    // Simulated Goja byte array [104, 101, 108, 108, 111] -> "hello"
